    ...
    return(
        <div className="home__data">
            ...
            <p className="home__description">
              &nbsp;&nbsp;&nbsp;&nbsp;
              Hi to all of you. In addition to being a creative developer based in BKK,
              I also love learning new things and have a strong work ethic.
              <br/>
              &nbsp;&nbsp;&nbsp;&nbsp;
              I'm now really interested in the fields of deep learning and machine learning, 
              which include computer vision and natural language processing.
              I am eager to collaborate with an organization that shares my enthusiasm. 
              to build a positive future experience
            </p>

            {/* <div className="home__warp_button">
